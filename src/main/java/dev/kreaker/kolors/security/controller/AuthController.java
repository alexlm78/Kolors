...
import dev.kreaker.kolors.security.service.PasswordResetService;
import dev.kreaker.kolors.security.service.UserService;
...
public class AuthController {
   ...
   /**
    * Process login form (this will be handled by Spring Security) This method is just for showing
    * the form, actual authentication is handled by Spring Security
    */
   @PostMapping("/login")
   ...
   public String processRegistration(
      ...
      try {
         ...
         // Register the user
         userService.registerUser(registerForm.getUsername(), registerForm.getEmail(),
   ...
   public String processForgotPassword(
      ...
      try {
         ...
         result.reject("error.forgotPasswordForm",
   ...
   public String processResetPassword(
      ...
      if (!form.getPassword().equals(form.getConfirmPassword())) {
         result.rejectValue("confirmPassword", "error.resetPasswordForm",
      ...
      try {
         ...
         if (success) {
            ...
            result.reject("error.resetPasswordForm",
                     "El enlace de restablecimiento es inválido o ha expirado.");
            return "auth/reset-password";
         }
      } catch (Exception e) {
