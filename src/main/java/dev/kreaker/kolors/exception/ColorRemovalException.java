...
/** Excepción lanzada cuando falla la operación de remover un color de una combinación */
public class ColorRemovalException extends RuntimeException {
    ...
    public static ColorRemovalException forCombination(Long combinationId, Integer position) {
        return new ColorRemovalException(
                "No se pudo remover el color en la posición "
                        + position
                        + " de la combinación con ID: "
                        + combinationId);
    }
    ...
    public static ColorRemovalException forLastColor() {
        return new ColorRemovalException(
                "No se puede remover el último color de la combinación. "
