...
public class EmptyCombinationException extends RuntimeException {
    ...
    public static EmptyCombinationException forCreation() {
        return new EmptyCombinationException("No se puede crear una combinación sin colores. "
                + "Debe agregar al menos un color");
    }

    public static EmptyCombinationException forUpdate(Long combinationId) {
        return new EmptyCombinationException("No se puede actualizar la combinación con ID "
                + combinationId + " dejándola sin colores");
    }

    public static EmptyCombinationException forRemoval(Long combinationId) {
        return new EmptyCombinationException("No se puede remover todos los colores de la combinación con ID "
                + combinationId + ". Una combinación debe tener al menos un color");
    }
}
