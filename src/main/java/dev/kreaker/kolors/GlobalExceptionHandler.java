...
/**
 * Global exception handling for the application Provides centralized error
 * handling with user-friendly localized messages
 */
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    public GlobalExceptionHandler(ColorCombinationService colorCombinationService, MessageSource messageSource) {
    ...
    public String handleColorCombinationValidation(ColorCombinationValidationException e,
        ...
        String errorMessage = getMessage("error.validation.multiple", String.join(", ", validationErrors));
    ...
    public String handleInvalidColorCount(InvalidColorCountException e,
            Model model,
            RedirectAttributes redirectAttributes) {
    ...
    public String handleColorAddition(ColorAdditionException e,
            Model model,
            RedirectAttributes redirectAttributes) {
    ...
    public String handleColorRemoval(ColorRemovalException e,
            Model model,
            RedirectAttributes redirectAttributes) {
    ...
    public String handleEmptyCombination(EmptyCombinationException e,
            Model model,
            RedirectAttributes redirectAttributes) {
