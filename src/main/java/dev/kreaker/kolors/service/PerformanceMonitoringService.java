...
/**
 * Service for monitoring application performance metrics Tracks query execution
 * times, method calls, and database operations
 */
@Service
public class PerformanceMonitoringService {
    ...
    public void recordDatabaseOperation(String operationName, Duration executionTime) {
        try {
            ...
            if (executionTimeMs > SLOW_QUERY_THRESHOLD_MS) {
                ...
                performanceLogger.info("Query performance warning: {} took {}ms", operationName, executionTimeMs);
            }
    ...
    public void recordServiceMethod(String methodName, Duration executionTime) {
        ...
        if (executionTimeMs > WARNING_QUERY_THRESHOLD_MS) {
            performanceLogger.info("Service method performance: {} took {}ms", methodName, executionTimeMs);
        }
    ...
    public void logPerformanceSummary() {
        ...
        performanceLogger.info("Slow queries: {} ({}%)", summary.getSlowQueries(), summary.getSlowQueryPercentage());
