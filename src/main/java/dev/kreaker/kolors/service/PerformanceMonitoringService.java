...
public class PerformanceMonitoringService {
        ...
        try {
            ...
            if (executionTimeMs > SLOW_QUERY_THRESHOLD_MS) {
                ...
                performanceLogger.warn(
                        "SLOW QUERY detected: {} took {}ms", operationName, executionTimeMs);
            ...
            logger.debug(
                    "Database operation '{}' completed in {}ms", operationName, executionTimeMs);
        } catch (Exception e) {
    ...
    public void logPerformanceSummary() {
        ...
        performanceLogger.info(
                "Slow queries: {} ({}%)",
                summary.getSlowQueries(), summary.getSlowQueryPercentage());
