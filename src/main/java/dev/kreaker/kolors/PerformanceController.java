...
/**
 * REST controller for performance monitoring and metrics Provides endpoints to
 * view and manage performance data
 */
@RestController
...
public class PerformanceController {
    ...
    public ResponseEntity<DatabasePerformanceSummary> getDatabasePerformance() {
        DatabasePerformanceSummary summary = performanceMonitoringService.getDatabasePerformanceSummary();
