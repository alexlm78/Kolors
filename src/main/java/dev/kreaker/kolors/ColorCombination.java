...
@Table(name = "color_combination",
         indexes = {@Index(name = "idx_comb_name", columnList = "name"),
...
public class ColorCombination {
   ...
   public Integer getNextAvailablePosition() {
      return colors.stream().mapToInt(ColorInCombination::getPosition).max().orElse(0) + 1;
   }
   ...
   public String toString() {
      return "ColorCombination{" + "id=" + id + ", name='" + name + '\'' + ", colorCount="
               + colorCount + ", createdAt=" + createdAt + '}';
   }
}
