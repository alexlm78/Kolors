...
public interface ColorInCombinationRepository extends JpaRepository<ColorInCombination, Long> {
     ...
     */
    List<ColorInCombination> findByCombinationIdAndPositionGreaterThanOrderByPosition(Long combinationId, Integer position);
    ...
    /**
     * Busca colores por patrón de valor hexadecimal (útil para búsquedas
     * parciales)
     */
    @Query("SELECT cic FROM ColorInCombination cic "
    ...
    /**
     * Cuenta cuántas veces se usa un color específico en todas las
     * combinaciones
     */
