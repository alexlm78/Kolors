...
public class MigrationStatistics {
   ...
   public String toString() {
      return "MigrationStatistics{" + "legacyRecordCount=" + legacyRecordCount
               + ", singleColorCombinationCount=" + singleColorCombinationCount
               + ", totalCombinationCount=" + totalCombinationCount + ", migrationStatus="
               + migrationStatus + ", lastMigrationTime=" + lastMigrationTime
               + ", lastMigrationSuccess=" + lastMigrationSuccess + ", progress="
