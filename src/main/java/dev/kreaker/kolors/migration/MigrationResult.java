...
public class MigrationResult {
   ...
   public String toString() {
      return "MigrationResult{" + "success=" + success + ", totalLegacyRecords="
               + totalLegacyRecords + ", migratedRecords=" + migratedRecords + ", failedRecords="
               + failedRecords + ", duration=" + getDurationInSeconds() + "s" + ", errors="
