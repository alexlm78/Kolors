...
/**
 * Integration tests for performance optimizations Verifies that database indexes and EntityGraph
...
public class PerformanceOptimizationTest {
   ...
   void testSearchPerformance() {
      ...
      for (int i = 1; i <= 10; i++) {
         ColorCombination combination = createTestCombination("Combination " + i,
                  String.format("%02X0000", i * 10), String.format("00%02X00", i * 10));
