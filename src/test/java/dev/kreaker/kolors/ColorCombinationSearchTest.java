...
class ColorCombinationSearchTest {
   ...
   void testFindByColorCountBetweenOrderByCreatedAtDesc() {
      ...
      List<ColorCombination> results =
               colorCombinationRepository.findByColorCountBetweenOrderByCreatedAtDesc(2, 3);
   ...
   void testFindByContainingHexValue() {
      ...
      List<ColorCombination> results =
               colorCombinationRepository.findByContainingHexValue("FF5733");
      assertThat(results).hasSize(1);
      assertThat(results.get(0).getName()).isEqualTo("Sunset Colors");
   ...
   void testFindByNameAndColorCountRange() {
      ...
      List<ColorCombination> results =
               colorCombinationRepository.findByNameAndColorCountRange("Colors", 2, 4);
      assertThat(results).hasSize(1);
      assertThat(results.get(0).getName()).isEqualTo("Sunset Colors");
   ...
   void testFindWithFilters() {
      ...
      Page<ColorCombination> results =
               colorCombinationRepository.findWithFilters("Colors", null, null, pageable);
   ...
   void testFindByContainingHexValueWithPagination() {
      ...
      Page<ColorCombination> results = colorCombinationRepository
               .findByContainingHexValueWithPagination("228B22", pageable);
      assertThat(results.getContent()).hasSize(1);
      assertThat(results.getContent().get(0).getName()).isEqualTo("Forest Greens");

      results = colorCombinationRepository.findByContainingHexValueWithPagination("FFFFFF",
               pageable);
   ...
   void testPaginationWithNameSearch() {
      ...
      Page<ColorCombination> results = colorCombinationRepository
               .findByNameContainingIgnoreCaseOrderByCreatedAtDesc("Test", firstPage);
      ...
      results = colorCombinationRepository
               .findByNameContainingIgnoreCaseOrderByCreatedAtDesc("Test", secondPage);
