...
class MigrationStatusTest {
    ...
    void shouldHaveCorrectDescriptions() {
        ...
        assertThat(MigrationStatus.COMPLETED.getDescription())
                .isEqualTo("Migration completed successfully");
        assertThat(MigrationStatus.COMPLETED_WITH_ERRORS.getDescription())
                .isEqualTo("Migration completed with errors");
        assertThat(MigrationStatus.FAILED.getDescription()).isEqualTo("Migration failed");
        assertThat(MigrationStatus.NO_LEGACY_DATA.getDescription())
                .isEqualTo("No legacy data found");
    }
    ...
    void shouldHaveCorrectToString() {
        ...
        assertThat(MigrationStatus.COMPLETED.toString())
                .isEqualTo("Migration completed successfully");
    }
}
