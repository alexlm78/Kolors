...
/**
 * Integration tests for database indexes and EntityGraph optimizations Tests
 * the core performance improvements without aspect monitoring
 */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
public class DatabaseIndexTest {
    ...
    void testDatabaseIndexes() {
        ...
        ColorCombination combination2 = createTestCombination("Performance Test 2", "123456", "FEDCBA");
        ColorCombination combination3 = createTestCombination("Different Name", "ABCDEF", "123456", "FEDCBA");
        ...
        // Test name index
        List<ColorCombination> performanceResults = colorCombinationRepository.findByNameContainingIgnoreCase("Performance");
        ...
        List<ColorCombination> abcdefResults = colorCombinationRepository.findByContainingHexValue("ABCDEF");
