...
class ColorCombinationSearchControllerTest {
    ...
    void testIndex_NoFilters() throws Exception {
        // Given
        List<ColorCombination> allCombinations = Arrays.asList(testCombination1, testCombination2, testCombination3);
    ...
    void testIndex_WithNameSearch() throws Exception {
        ...
        verify(colorCombinationService).searchWithFilters(eq(searchTerm), isNull(), isNull(), isNull());
    }
    ...
    void testIndex_WithColorCountFilter() throws Exception {
        ...
        when(colorCombinationService.searchWithFilters(isNull(), eq(colorCount), eq(colorCount), isNull()))
                .thenReturn(filteredCombinations);
        ...
        verify(colorCombinationService).searchWithFilters(isNull(), eq(colorCount), eq(colorCount), isNull());
    }
    ...
    void testIndex_WithColorRange() throws Exception {
        ...
        Integer minColors = 2;
        Integer maxColors = 3;
        List<ColorCombination> filteredCombinations = Arrays.asList(testCombination1, testCombination2);
        when(colorCombinationService.searchWithFilters(isNull(), eq(minColors), eq(maxColors), isNull()))
                .thenReturn(filteredCombinations);
        ...
        verify(colorCombinationService).searchWithFilters(isNull(), eq(minColors), eq(maxColors), isNull());
    }
    ...
    void testIndex_WithMultipleFilters() throws Exception {
        ...
        Integer maxColors = 4;
        List<ColorCombination> filteredCombinations = Arrays.asList(testCombination1);
        when(colorCombinationService.searchWithFilters(eq(searchTerm), eq(minColors), eq(maxColors), isNull()))
                .thenReturn(filteredCombinations);
        ...
        verify(colorCombinationService).searchWithFilters(eq(searchTerm), eq(minColors), eq(maxColors), isNull());
    }
    ...
    void testSearchEndpoint_AJAX() throws Exception {
        ...
        List<ColorCombination> filteredCombinations = Arrays.asList(testCombination2);
        when(colorCombinationService.searchWithFilters(eq(searchTerm), eq(colorCount), eq(colorCount), isNull()))
                .thenReturn(filteredCombinations);
        ...
        verify(colorCombinationService).searchWithFilters(eq(searchTerm), eq(colorCount), eq(colorCount), isNull());
    }
    ...
    void testSearchEndpoint_WithRangeFilters() throws Exception {
        ...
        Integer minColors = 3;
        Integer maxColors = 4;
        List<ColorCombination> filteredCombinations = Arrays.asList(testCombination1, testCombination3);
        when(colorCombinationService.searchWithFilters(isNull(), eq(minColors), eq(maxColors), isNull()))
                .thenReturn(filteredCombinations);
    ...
    void testPaginatedSearch() throws Exception {
        ...
        Page<ColorCombination> combinationPage = new PageImpl<>(combinations, PageRequest.of(page, size), 10);

        when(colorCombinationService.searchWithFilters(eq(searchTerm), isNull(), isNull(), isNull(), any()))
                .thenReturn(combinationPage);

        // When & Then
        mockMvc.perform(get("/combinations/paginated")
                .param("search", searchTerm)
        ...
        verify(colorCombinationService).searchWithFilters(eq(searchTerm), isNull(), isNull(), isNull(), any());
    }
    ...
    void testPaginatedSearch_WithAllFilters() throws Exception {
        ...
        Page<ColorCombination> combinationPage = new PageImpl<>(combinations, PageRequest.of(page, size), 1);

        when(colorCombinationService.searchWithFilters(isNull(), isNull(), isNull(), eq(hexValue), any()))
                .thenReturn(combinationPage);
        ...
        verify(colorCombinationService).searchWithFilters(isNull(), isNull(), isNull(), eq(hexValue), any());
    }
