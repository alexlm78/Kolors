...
class GlobalExceptionHandlerTest {
  ...
  void shouldHandleColorCombinationNotFoundException() {
    ...
    // When
    String result =
        exceptionHandler.handleColorCombinationNotFound(exception, model, redirectAttributes);
  ...
  void shouldHandleInvalidColorCountException() {
    ...
    when(messageSource.getMessage(
            eq("error.combination.colors.required"), any(), anyString(), any(Locale.class)))
    ...
    assertEquals("redirect:/combinations/", result);
    verify(redirectAttributes)
        .addFlashAttribute(eq("error"), eq("Debe agregar al menos un color a la combinación"));
  }
  ...
  void shouldHandleColorAdditionException() {
    ...
    when(messageSource.getMessage(
            eq("error.combination.color.add.failed"), any(), anyString(), any(Locale.class)))
  ...
  void shouldHandleColorRemovalException() {
    ...
    when(messageSource.getMessage(
            eq("error.combination.color.remove.failed"), any(), anyString(), any(Locale.class)))
    ...
    assertEquals("redirect:/combinations/", result);
    verify(redirectAttributes)
        .addFlashAttribute(eq("error"), eq("No se pudo remover el color de la combinación"));
  }
  ...
  void shouldHandleEmptyCombinationException() {
    ...
    when(messageSource.getMessage(
            eq("error.combination.colors.empty"), any(), anyString(), any(Locale.class)))
  ...
  void shouldHandleDatabaseErrors() {
    ...
    verify(redirectAttributes)
        .addFlashAttribute(
            eq("error"), eq("Error de base de datos. Por favor, inténtelo de nuevo más tarde"));
  }
  ...
  void shouldHandleIllegalArgumentException() {
    ...
    assertEquals("redirect:/combinations/", result);
    verify(redirectAttributes)
        .addFlashAttribute(eq("error"), eq("Datos inválidos proporcionados: Invalid argument"));
  }
  ...
  void shouldHandleGenericExceptions() {
    ...
    verify(redirectAttributes)
        .addFlashAttribute(
            eq("error"), eq("Ha ocurrido un error inesperado. Por favor, inténtelo de nuevo"));
  }
