...
class GlobalExceptionHandlerTest {
   ...
   void shouldHandleColorCombinationNotFoundException() {
      ...
      when(messageSource.getMessage(eq("error.combination.notfound"), any(), anyString(),
               any(Locale.class))).thenReturn("Combinación de colores no encontrada");

      // When
      String result = exceptionHandler.handleColorCombinationNotFound(exception, model,
               redirectAttributes);

      // Then
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("Combinación de colores no encontrada"));
   }
   ...
   void shouldHandleColorCombinationValidationException() {
      ...
      when(messageSource.getMessage(eq("error.validation.multiple"), any(), anyString(),
               any(Locale.class))).thenReturn("Errores de validación: Error 1, Error 2");
   ...
   void shouldHandleInvalidColorFormatException() {
      ...
      when(messageSource.getMessage(eq("error.color.invalid.hex"), any(), anyString(),
               any(Locale.class))).thenReturn("Formato de color hexadecimal inválido");
      ...
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("Formato de color hexadecimal inválido"));
   }
   ...
   void shouldHandleInvalidColorCountException() {
      ...
      when(messageSource.getMessage(eq("error.combination.colors.required"), any(), anyString(),
               any(Locale.class))).thenReturn("Debe agregar al menos un color a la combinación");
      ...
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("Debe agregar al menos un color a la combinación"));
   }
   ...
   void shouldHandleColorAdditionException() {
      ...
      when(messageSource.getMessage(eq("error.combination.color.add.failed"), any(), anyString(),
               any(Locale.class))).thenReturn("No se pudo agregar el color a la combinación");
      ...
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("No se pudo agregar el color a la combinación"));
   }
   ...
   void shouldHandleColorRemovalException() {
      ...
      when(messageSource.getMessage(eq("error.combination.color.remove.failed"), any(), anyString(),
               any(Locale.class))).thenReturn("No se pudo remover el color de la combinación");
      ...
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("No se pudo remover el color de la combinación"));
   }
   ...
   void shouldHandleEmptyCombinationException() {
      ...
      when(messageSource.getMessage(eq("error.combination.colors.empty"), any(), anyString(),
               any(Locale.class))).thenReturn("La combinación no puede estar vacía");
      ...
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"),
               eq("La combinación no puede estar vacía"));
   }
   ...
   void shouldHandleValidationException() {
      ...
      when(colorCombinationService.getStatistics())
               .thenReturn(new ColorCombinationService.CombinationStatistics(0, 0, 0, 0));
      when(messageSource.getMessage(eq("error.validation.bean"), any(), anyString(),
               any(Locale.class))).thenReturn("Error de validación: Bean validation error");
   ...
   void shouldHandleDatabaseErrors() {
      ...
      when(messageSource.getMessage(eq("error.database.generic"), any(), anyString(),
               any(Locale.class)))
   ...
   void shouldHandleIllegalArgumentException() {
      ...
      when(messageSource.getMessage(eq("error.server.illegal.argument"), any(), anyString(),
               any(Locale.class))).thenReturn("Datos inválidos proporcionados: Invalid argument");
   ...
   void shouldHandleGenericRuntimeException() {
      ...
      when(messageSource.getMessage(eq("error.server.runtime"), any(), anyString(),
      ...
      // Then
      assertEquals("redirect:/combinations/", result);
      verify(redirectAttributes).addFlashAttribute(eq("error"), eq(
               "Error del sistema. Por favor, contacte al administrador si el problema persiste"));
   }
   ...
   void shouldHandleGenericExceptions() {
      ...
      when(messageSource.getMessage(eq("error.server.generic"), any(), anyString(),
               any(Locale.class)))
